...
public class RentMateActivity extends AppCompatActivity
    implements NavigationView.OnNavigationItemSelectedListener, ClaimListFragment.Callbacks, MyApptListFragment.Callbacks {
  ...
  public void onApartmentSelected() {
    ...
    Fragment fragment = fm.findFragmentById(R.id.my_apartment_detail);
    if (fragment == null) {
